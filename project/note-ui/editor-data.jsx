...
const SLASH_ITEMS = [
  // ── AJOUTER ──────────────────────────────────────────────
  { key: 'add-file', section: 'Ajouter', icon: 'upload_file', title: 'Ajouter des fichiers', desc: 'PDF, image depuis ordinateur…', kbd: 'Alt+A',
    kbdNoSlash: true, fileAction: true },
  { key: 'add-section', section: 'Ajouter', icon: 'add', title: 'Ajouter une section', desc: 'Nouvelle section de texte libre', kbd: 'sec',
    addSection: true },
  { key: 'instructions', section: 'Ajouter', icon: 'menu_book', title: 'Instructions patient', desc: 'Consignes au patient', kbd: 'instr',
    template: { type: 'instructions', label: 'Consignes', text: 'Consignes au patient',
      details: { title: '', body: '', delivery: 'Imprimer + portail' } } },
  // ── OUTILS ───────────────────────────────────────────────
  { key: 'textes-rapides', section: 'Outils', icon: 'bolt', title: 'Textes rapides', desc: 'Insérer un modèle de texte', kbd: 'Ctrl+R',
    kbdNoSlash: true, textRapides: true },
  { key: 'diagnostic', section: 'Outils', icon: 'local_hospital', title: 'Diagnostic', desc: 'Créer une section diagnostic', kbd: 'dx',
    diagnosticEntry: true },
  { key: 'prescription', section: 'Outils', icon: 'prescriptions', title: 'Prescriptions', desc: 'Rechercher et prescrire un médicament', kbd: 'rx',
    rxSearch: true },
  { key: 'lab', section: 'Outils', icon: 'science', title: 'Laboratoire', desc: 'FSC, TSH, bilan…', kbd: 'lab',
    orderSearch: true,
    template: { type: 'lab', label: 'Demande de laboratoire', text: 'Demande de laboratoire',
      details: { tests: ['FSC'], priority: 'Routine', fasting: false, context: '', collection: 'Au CH le plus proche' } } },
  { key: 'imaging', section: 'Outils', icon: 'radiology', title: 'Imagerie', desc: 'Radio, écho, TDM', kbd: 'img',
    orderSearch: true,
  ...
  { key: 'referral', section: 'Outils', icon: 'person_add', title: 'Référence spécialiste', desc: 'Cardio, ortho, derm…', kbd: 'ref',
    orderSearch: true,
  ...
  { key: 'outils-cliniques', section: 'Outils', icon: 'handyman', title: 'Outils cliniques', desc: 'Score, calculatrice, outil clinique…', kbd: '',
