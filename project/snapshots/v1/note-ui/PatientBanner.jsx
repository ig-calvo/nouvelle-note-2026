...
function PatientBanner() {
  ...
  return expanded ? (
    <div style={pbStyles.card}>
      ...
      {/* Contact */}
      <div style={{ ...pbStyles.contactCol, flex: 1, width: undefined }} data-comment-anchor="6d4d1b26f2-div-28-7">
      ...
      <div style={pbStyles.actions}>
        ...
        <button style={pbStyles.ghostBtn} aria-label="réduire" onClick={() => setExpanded(false)}>
    ...
    /* ── Collapsed row ── */
    <div style={pbStyles.collapsedCard}>
      {/* Left: avatar + inline patient info */}
      ...
      {/* Right: action icons + consent badge + chevron */}
      <div style={pbStyles.collapsedActions}>
        ...
        <button style={{ ...pbStyles.iconBtn, border: 0 }} aria-label="étendre" onClick={() => setExpanded(true)}>
...
const pbStyles = {
  ...
  avatar: {
    width: 34, height: 34, borderRadius: "50%", background: "#ece3f5",
  ...
  fileChip: {
    ...
    border: "1px solid #e0e0e0", borderRadius: 6, padding: "3px 9px",
  ...
  calBtn: {
    width: 40, height: 40, borderRadius: 8, border: 0, background: "#23235a", cursor: "pointer",
    display: "inline-flex", alignItems: "center", justifyContent: "center",
  },
  ghostBtn: {
    width: 40, height: 40, borderRadius: 8, border: 0, background: "transparent", cursor: "pointer",
    display: "inline-flex", alignItems: "center", justifyContent: "center",
  },
  ...
  avatarSm: {
    width: 28, height: 28, borderRadius: "50%", background: "#ece3f5",
    display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0,
  },
  ...
  collapsedFileChip: {
    ...
    border: "1px solid #e0e0e0", borderRadius: 6, padding: "2px 8px",
    fontSize: 13, color: "rgba(0,0,0,0.7)", whiteSpace: "nowrap",
  },
  collapsedLangChip: {
    border: "1px solid #e0e0e0", borderRadius: 6, padding: "2px 8px",
    fontSize: 13, color: "rgba(0,0,0,0.7)", fontWeight: 500, whiteSpace: "nowrap",
  },
  collapsedActions: { display: "flex", alignItems: "center", gap: 4, flexShrink: 0 },
  iconBtn: {
    width: 34, height: 34, borderRadius: 7, border: "1px solid #e5e5e5",
    background: "#fff", cursor: "pointer",
    display: "inline-flex", alignItems: "center", justifyContent: "center",
  },
  iconBtnIc: { fontSize: 20, color: "rgba(0,0,0,0.55)" },
  consentBadge: {
    width: 34, height: 34, borderRadius: 7, border: "1.5px solid #1565c0",
    background: "#fff", cursor: "pointer",
    display: "inline-flex", alignItems: "center", justifyContent: "center",
  },
};
